...
library(cluster)
agnes_result <- agnes(data[, 2:7], method = "complete")  # You can choose a different agglomeration method as needed

# Plot the clusters
plot(agnes_result, main = "AGNES Clustering of Universities")
