...
# Scatter plot
plot(data$SAT, data$Expenses, xlab = "SAT", ylab = "Expenses", main = "SAT vs Expenses")

# Bar plot
barplot(data$GradRate, names.arg = data$Univ, xlab = "University", ylab = "Graduation Rate", 
        las = 2, cex.names = 0.7, main = "Graduation Rate by University")

# Histogram
hist(data$Accept, xlab = "Acceptance Rate", main = "Distribution of Acceptance Rate")
